      ...
      <div className='w-full'>
        ...
        <div className='max-w-6xl mx-auto p-3 flex flex-col gap-8 py-7'>
          <div className='flex flex-col gap-6'>
            ...
            ) : favouritesPost.length === 0 ? ( // Check if favouritesPost is empty
              <div className='flex justify-center items-center h-full w-full'>
                <p className='text-lg text-gray-500'>No favourites found. To see all blogs, click here: </p>
                <Link
                  to={"/search"}
                  className='text-lg text-teal-500 hover:underline text-center ml-2'>
                  View all posts
                </Link>
              </div>
            ) : (
